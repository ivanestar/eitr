...
2. Dispatch task to specialized subagents or execute the corresponding operational skill (/map-site, /derive-test-conditions, /automate-ticket, /scan-and-generate-pom, /heal-test, /bulk-rescan).
