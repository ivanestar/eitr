...
/** tests/examples/cpom-showcase.spec.js */
export function renderJsCpomShowcase(): string {
...
import { test, expect } from '\x40playwright/test';
import { BasePage } from '../../components/base/base-page.js';
import { Table } from '../../components/widgets/table.js';
import { Dialog } from '../../components/widgets/dialog.js';
import { Link } from '../../components/primitives/link.js';
import { TextInput } from '../../components/primitives/text-input.js';
import { NativeSelect } from '../../components/primitives/native-select.js';
...
/** tests/examples/api-showcase.spec.js */
export function renderJsApiExampleSpec(): string {
  return `import { test, expect } from '\x40playwright/test';
import { ApiClient } from '../../shared/utils/api-client.js';
...
test.describe('API Showcase Tests', () => {
  test('REST GET request demo', async ({ request }) => {
    ...
    const response = await api.get('https://jsonplaceholder.typicode.com/todos?_limit=2');
  ...
  test('GraphQL query request demo', async ({ request }) => {
    ...
    try {
      const response = await api.graphql(query, { code: 'CA' });
