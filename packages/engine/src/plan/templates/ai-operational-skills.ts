...
6. **Business-Intent & Criticality Analysis (Automatic, Strictly Read-Only):**
   ...
   - **Next step:** once reviewed, run \`/derive-test-conditions\` to synthesize test conditions from the reviewed routes.
