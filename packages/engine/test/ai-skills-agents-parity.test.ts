...
describe('Polymorphic AI Operational Skills & AI Agents Parity (AC-5, AC-6, AC-7)', () => {
  describe('Pillar 2: Operational Skills Polyglot Parity', () => {
    ...
    frozenIt(
      'TypeScript Cypress: emits cy.session, Cypress.env, cypress/e2e/ paths, and zero trace.zip',
      () => {
    ...
    frozenIt(
      'Python pytest: emits pytest, python scripts/lint_cpom.py, os.getenv, and fixtures/auth_setup.py',
      () => {
    ...
    frozenIt(
      'C# NUnit: emits dotnet test, dotnet build -t:LintCpom, Environment.GetEnvironmentVariable, and class filter',
      () => {
    ...
    frozenIt(
      'Java JUnit 5: emits mvn test / ./gradlew test, java scripts/LintCpom.java, and System.getenv',
      () => {
  ...
  describe('Pillar 3: AI Agents Polyglot Parity', () => {
    frozenIt(
      'Python agents: emit snake_case page paths, _now() suffix, None return type, and zero Promise/test.step',
      () => {
    ...
    frozenIt(
      'C# agents: emit PascalCase page paths, NowAsync() suffix, Task return type, and zero Promise/process.env',
      () => {
    ...
    frozenIt(
      'Java agents: emit Java directory structure, Now() suffix, void return type, and zero Promise/process.env',
      () => {
