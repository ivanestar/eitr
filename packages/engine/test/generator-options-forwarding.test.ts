...
describe('TargetGenerator Options Forwarding to planSharedScaffold (AC-3)', () => {
  frozenIt(
    'CsharpPlaywrightGenerator forwards language=csharp and automationTool=playwright to planSharedScaffold when opts is empty',
    () => {
  ...
  frozenIt(
    'PytestPlaywrightGenerator forwards language=python to planSharedScaffold when opts is empty',
    () => {
  ...
  frozenIt(
    'CypressTsGenerator forwards automationTool=cypress to planSharedScaffold when opts is empty',
    () => {
