...
- **Mandatory 5-Stage Workflow Before Writing Code**: Before writing even a single line of code, you MUST strictly execute the following pipeline in order:
  ...
  5. **`doc-sync-enforcer`**: Synchronize all technical documentation (`README.md`, `docs/architecture.md`, `docs/roadmap.md`, `CHANGELOG.md`, `AGENTS.md`, `CLAUDE.md`) and package version manifests to reflect the changes.
